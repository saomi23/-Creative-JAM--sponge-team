...
/*
		...
		function addElement(){
			var objBody1 = document.getElementsByTagName("ul").item(i);
			objBody1.appendChild(element1);
			var objBody2 = document.getElementsByTagName("li").item(0);
			objBody2.appendChild(element2);
			var objBody3 = document.getElementsByTagName("li").item(0);
			objBody3.appendChild(element3);
			var objBody4 = document.getElementsByTagName("li").item(0);
			objBody4.appendChild(element4);
			var objBody5 = document.getElementsByTagName("div").item(0);
			objBody5.appendChild(element5);
			var objBody6 = document.getElementsByTagName("div").item(1);
